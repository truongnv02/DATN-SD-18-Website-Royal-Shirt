        ...
        <div class="col-12" style="border-top: 2px solid #d7dce0;">
            <div class="row">
                ...
                <div class="col-sm-6 col-md-4 col-xl-3 ">
                    <label for="image${color}_1"
                        class="border border-primary mt-2"
                        style="border-width: 4px !important; width: 200px; height: 250px;">
                        <img src="/assets/images/no_image.jpg" id="imagePreview${color}_1" class="over " />
                    </label>
                    <input type="file" class="custom-file-input image"
                        style="height: 0;" id="image${color}_1" name="image${color}_1"
                        accept=".jpg,.png,.jpeg"
                        onchange="readURL(this,event,'${color}_1')">
                </div>
                <div class="col-sm-6 col-md-4 col-xl-3">
                    <label for="image${color}_2"
                        class="border border-primary mt-2"
                        style="border-width: 4px !important; width: 200px; height: 250px;">
                        <img src="/assets/images/no_image.jpg" id="imagePreview${color}_2" class="over " />
                    </label>
                    <input type="file" class="custom-file-input image"
                        style="height: 0;" id="image${color}_2" name="image${color}_2"
                        accept=".jpg,.png,.jpeg"
                        onchange="readURL(this,event,'${color}_2')">
                </div>
                <div class="col-sm-6 col-md-4 col-xl-3">
                    <label for="image${color}_3"
                        class="border border-primary mt-2"
                        style="border-width: 4px !important; width: 200px; height: 250px;">
                        <img src="/assets/images/no_image.jpg" id="imagePreview${color}_3" class="over " />
                    </label>
                    <input type="file" class="custom-file-input image"
                        style="height: 0;" id="image${color}_3" name="image${color}_3"
                        accept=".jpg,.png,.jpeg"
                        onchange="readURL(this,event,'${color}_3')">
                </div>
                <div class="col-sm-6 col-md-4 col-xl-3">
                    <label for="image${color}_4"
                        class="border border-primary mt-2"
                        style="border-width: 4px !important; width: 200px; height: 250px;">
                        <img src="/assets/images/no_image.jpg" id="imagePreview${color}_4" class="over " />
                    </label>
                    <input type="file" class="custom-file-input image"
                        style="height: 0;" id="image${color}_4" name="image${color}_4"
                        accept=".jpg,.png,.jpeg"
                        onchange="readURL(this,event,'${color}_4')">
                </div>
            </div>
            </div>
    `);
